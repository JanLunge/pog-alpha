<template>
  ...
  <div class="relative w-full h-64" :style="{width: keyboardWidth * 58+'px',height: keyboardHeight * 58+'px'}">
    <key-cap v-for="key in keyLayout.keys" @selected="keyChanged" :key-layout="keyLayout.info" :key-data="key" :keymap="keymap" >
    </key-cap>
  </div>
  </div>
</template>
